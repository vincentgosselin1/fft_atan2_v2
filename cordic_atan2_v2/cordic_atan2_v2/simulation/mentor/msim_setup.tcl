...
# ----------------------------------------
# If cordic_atan2_v2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2020.03.01.18:14:35
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "cordic_atan2_v2"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cordic_atan2_v2_CORDIC_0.vhd" -work CORDIC_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cordic_atan2_v2.vhd"                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L CORDIC_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L CORDIC_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
