...
# ----------------------------------------
# If FFT_Burst_16x1024_v1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2020.02.16.21:22:00
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FFT_Burst_16x1024_v1"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_2n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_3n1024cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_3n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_1n1024cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_1n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_2n1024cos.hex ./
}
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0.sv"                   -work fft_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/FFT_Burst_16x1024_v1.vhd"                                                    
}
