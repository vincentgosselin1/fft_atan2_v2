...
TOP_LEVEL_NAME="FFT_Burst_16x1024_v1"
QSYS_SIMDIR="./../"
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_2n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_3n1024cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_3n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_1n1024cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_1n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0_2n1024cos.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FFT_Burst_16x1024_v1_fft_ii_0.sv"          -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/FFT_Burst_16x1024_v1.vhd"                                                                               
fi
